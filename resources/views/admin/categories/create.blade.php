            ...
            <div class="card-body">
                <ul class="list-unstyled">
                    <li class="mb-2">
                        ...
                        <strong>Category Name:</strong> Enter a unique name for the category.
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-info-circle text-primary me-2"></i>
                        <strong>Parent Category:</strong> Select if this is a sub-category.
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-info-circle text-primary me-2"></i>
                        <strong>Status:</strong> Active categories will be visible on the website.
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-info-circle text-primary me-2"></i>
                        <strong>Image:</strong> Upload a clear image representing the category.
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-info-circle text-primary me-2"></i>
