                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('established_year', $brand->established_year) }}"
                                   min="1800"
                                   max="{{ date('Y') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                          ...
                                          rows="3">{{ old('meta_description', $brand->meta_description) }}</textarea>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-8">{{ $brand->created_at->format('d M Y, h:i A') }}</dd>
                    
                    <dt class="col-sm-4">Last Updated</dt>
                    <dd class="col-sm-8">{{ $brand->updated_at->format('d M Y, h:i A') }}</dd>
            ...
            <div class="card-body">
                @if($brand->products_count > 0)
                    <div class="alert alert-warning">
                        ...
                        This brand contains products. Delete products first.
                    </div>
                @else
